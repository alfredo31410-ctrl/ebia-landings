...
export function LandingPage({ campaign, registrationError = false }: { campaign: LandingCampaign; registrationError?: boolean }) {
  ...
  return <main className="campaign">
    ...
    <section className="hero-section"><div className="shell hero-layout">
      ...
      <div className="hero-visual"><div className="hero-blob"/><div className="hero-grid"/><Image className="instructor" src="/landings/media/ia-desde-cero/Foto1.png" alt={campaign.image.alt} width={1067} height={1600} priority sizes="(max-width: 800px) 100vw, 52vw"/><div className="process-cards"><article><b>✦</b><span>Idea<strong>desordenada</strong></span></article><i>↓</i><article><b>⌁</b><span>Prompt<strong>mejorado</strong></span></article><i>↓</i><article><b>✓</b><span>Resultado<strong>útil</strong></span></article></div><div className="visual-badges"><span>◉ Nivel inicial</span><span>ϟ Ejercicios prácticos</span></div></div>
