...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const trackView = () => {
      ...
      if (typeof window.fbq === "function") {
        window.fbq("track", "ViewContent", { content_name: content.product.name, value: content.price.amount, currency: content.price.currency });
        viewed.current = true;
  ...
  return <main className="ecosystem-page challenge-page">
    <div className="ecosystem-topline"><span className="status-dot" /> Reto práctico en vivo · Nivel inicial</div>
    ...
    <section className="ecosystem-hero" id="inicio"><div className="ecosystem-shell ecosystem-hero-grid"><div className="ecosystem-hero-copy"><p className="ecosystem-eyebrow">{content.eyebrow}</p><h1>{content.product.name}</h1><p className="ecosystem-lead">{content.promise}</p><div className="ecosystem-actions"><a className="ecosystem-primary" href={href} onClick={buy}>{cta} <Arrow /></a><a className="ecosystem-text-link" href="#incluye">Ver qué incluye <span>↓</span></a></div><p className="ecosystem-microcopy">{content.price.paymentLabel} · {content.price.formatted} · Pago seguro procesado por Hotmart.</p><p className="seller-note">La compra es procesada para {content.seller}.</p></div><div className="ecosystem-visual challenge-visual" aria-label="Composición visual del reto práctico de inteligencia artificial" role="img"><div className="visual-glow" /><div className="visual-grid" /><div className="visual-card visual-card--main"><small>reto práctico</small><strong>3 días para comenzar a aplicar IA</strong><div className="visual-progress"><i /><i /><i /></div><span>Desde cero · en vivo</span></div><div className="visual-card visual-card--float"><b>IA</b><span>ahorra tiempo<br />crea mejor</span></div><div className="visual-orbit orbit-one" /><div className="visual-orbit orbit-two" /></div></div></section>
    ...
    <section className="ecosystem-final"><div className="ecosystem-shell"><p className="ecosystem-kicker">17 al 19 de agosto · 3 días en vivo</p><h2>Empieza a utilizar la inteligencia artificial con una guía práctica.</h2><p>Participa en tres días en vivo diseñados para ayudarte a comenzar desde cero, ahorrar tiempo, crear contenido y mejorar tu productividad.</p><div className="final-price">{content.price.formatted} <small>{content.price.paymentLabel}</small></div><a className="ecosystem-primary" href={href} onClick={buy}>{cta} <Arrow /></a><small>Pago seguro procesado por Hotmart.</small></div></section>
