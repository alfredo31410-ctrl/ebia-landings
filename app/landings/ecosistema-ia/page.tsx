...
export default function Page() {
  ...
  return <main className="ecosystem-page challenge-page">
    ...
    <section className="ecosystem-hero" id="inicio"><div className="ecosystem-shell ecosystem-hero-grid"><div className="ecosystem-hero-copy"><p className="ecosystem-eyebrow">{content.eyebrow}</p><h1>{content.product.name}</h1><p className="ecosystem-lead">{content.promise}</p><div className="ecosystem-actions"><a className="ecosystem-primary" href={href} onClick={buy}>{cta} <Arrow /></a><a className="ecosystem-text-link" href="#incluye">Ver qué incluye <span>↓</span></a></div><p className="ecosystem-microcopy">{content.price.paymentLabel} · {content.price.formatted} · Pago seguro procesado por Hotmart.</p><p className="seller-note">La compra es procesada para {content.seller}.</p></div><div className="ecosystem-visual challenge-visual" aria-label="Fotografía de la instructora del reto práctico de inteligencia artificial" role="img"><div className="visual-glow" /><div className="visual-grid" /><Image className="hero-instructor" src="/landings/ia-desde-cero/instructora.png" alt="Instructora del reto práctico de inteligencia artificial" width={1067} height={1600} priority sizes="(max-width: 620px) 92vw, (max-width: 1024px) 48vw, 470px" /><div className="visual-card visual-card--main"><small>reto práctico</small><strong>3 días para comenzar a aplicar IA</strong><div className="visual-progress"><i /><i /><i /></div><span>Desde cero · en vivo</span></div><div className="visual-card visual-card--float"><b>IA</b><span>ahorra tiempo<br />crea mejor</span></div><div className="visual-orbit orbit-one" /><div className="visual-orbit orbit-two" /></div></div></section>
