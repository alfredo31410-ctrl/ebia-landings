export const ACTIVE_CAMPAIGN_ACCOUNT =
  process.env.NEXT_PUBLIC_ACTIVE_CAMPAIGN_ACCOUNT || "cefincapacitacion";
...
// Deben contrastarse con el HTML real de cada formulario en ActiveCampaign.
